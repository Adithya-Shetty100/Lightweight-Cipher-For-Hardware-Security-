...
HD_PWD='E:/Capstone/KeyGenerator/KeyGenerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lfsr_32bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lfsr_32bit.tcl -notrace
