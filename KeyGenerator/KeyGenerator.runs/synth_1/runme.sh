...
HD_PWD='E:/Capstone/KeyGenerator/KeyGenerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lfsr_32bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lfsr_32bit.tcl
