...
HD_PWD='E:/Capstone/Lightweight-Cipher-For-Hardware-Security-/ECC/ECC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ecc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ecc.tcl
